...
if (isset($_POST['update'])) {
    ...
    $Availability = mysqli_real_escape_string($connection, $_POST['units']);

    $query = "UPDATE products
              SET qty = '{$Availability}'
...
<body>
    ...
    <form action="editItemUnits.php" method="POST">
        Update Units: <input type="text" name="units" required>
        <br>
        <input type="submit" name="update" value="Update Availability">
