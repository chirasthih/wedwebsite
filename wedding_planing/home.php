            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide">
                  <img src="How-to-Start-Your-Wedding-Photography-Business.png" alt="">
                    <div class="content">
                        ...
                        <a href="../Photography/index.html" class="btn">Look for more</a>
                    </div>
                </div>
                ...
                <div class="swiper-slide slide">
                  <img src="hotel-exterior.jpg" alt="">
                    <div class="content">
                         <h3>Hotels</h3>
                         <p>Select your venue</p>
                         <a href="../hotels/Index.php" class="btn">about us</a>
                    </div>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <div class="content">
                        <h3>Salon</h3>
                        <p>Mark your presence significantly at your big day</p>
                        <a href="../Salon/haircare-master/contact.php" class="btn">Look for more</a>
                    </div>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <div class="content">
                        <h3>Music</h3>
                        <p>Music for your day</p>
                        <a href="../Music/index.php" class="btn">Look for more</a>
                    </div>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <div class="content">
                        <h3>Jewellary</h3>
                        <p>luxurious jewellary to make your day grand</p>
                        <a href="../jewelllary/contact.php" class="btn">look for more</a>
                    </div>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <div class="content">
                        <h3>Wedding cakes</h3>
                        <p>Cakes and catering services</p>
                        <a href="about.php" class="btn">Look for more</a>
                    </div>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <div class="content">
                        <h3>Decorations</h3>
                        <p>Deco your venue with us</p>
                        <a href="../Decor/index.php" class="btn">Look for more</a>
                    </div>
                </div>
                 ...
                 <div class="swiper-slide slide">
                    ...
                    <div class="content">
                        ...
                        <p>Dress with us</p>
                        <a href="../Dress/Index.php" class="btn">Look for more</a>
                    </div>
                </div>
            </div>
            <div class="swiper-pagination"></div>
